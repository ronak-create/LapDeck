// Detect Tailscale identity on Linux (for control-from-anywhere + the HTTPS app
// URL). Same CLI surface as win/network.js; only the candidate paths differ.
...
function run(args) {
  return new Promise((resolve) => {
    ...
    const tryNext = () => {
      ...
      execFile(CANDIDATES[i++], args, { timeout: 4000 }, (err, stdout) => {
